...
<body>
        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl bg-primary page-header">
                <div class="container text-center">
                    <h1 class="text-white animated zoomIn mb-3">Teknik Bisnis Sepeda Motor</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="{{ route('beranda')}}">Beranda</a></li>
                            <li class="breadcrumb-item"><a class="text-white">TBSM</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl py-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <img src="{{ asset('guest/img/jurusan/tbsm.jpg')}}" class="img-fluid" alt="...">
                        <br>
                        <br>
                        <br>
                    </div>
                </div>
                    <p align="justify" class="fadeInUp">Teknik dan Bisnis Sepeda Motor (TBSM) adalah salah satu cabang ilmu teknik mesin yang mempelajari tentang bagaimana merancang, membuat dan mengembangkan alat-alat transportasi darat yang menggunakan mesin, terutama sepeda motor. Teknik dan Bisnis Sepeda Motor (TBSM) menggabungkan elemen-elemen pengetahuan mekanika, listrik, elektronik, keselamatan dan lingkungan serta matematika, fisika, kimia, ipa dan manajemen.
                        Ruang Lingkup pekerjaan bagi lulusan Program Keahlian Teknik Sepeda Motor adalah jenis pekerjaan dan atau profesi yang relevan pada jenjang SMK antara lain adalah:</p>
                        <br>
                        <br>
                        <p align="left" class="fadeInUp">1. Teknisi mekanik otomotif dalam bidang perawatan dan perbaikan kendaraan bermotor bensin</p>
                        <p align="left" class="fadeInUp">2. Perawatan dan perbaikan chasis dan system pemindahan tenaga.</p>
                        <p align="left" class="fadeInUp">3. Perawatan dan perbaikan system kelistrikan</p>
                        <p align="left" class="fadeInUp">4. Mampu mengelola usaha mandiri di bidang perbengkelan kendaraan sepeda motor.</p>
            </div>
        </div>
        <!-- 404 End -->
    ...
    <script src="{{ asset('guestlib/easing/easing.min.js')}}"></script>
