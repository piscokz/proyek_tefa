<!-- Footer Start -->
<div class="container-fluid bg-dark text-light footer pt-5 wow fadeIn" data-wow-delay="0.1s" style="margin-top: 6rem; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.5);">
        ...
        <div class="row g-5">
            <div class="col-md-6 col-lg-4">
                ...
                <div class="d-flex pt-2 social-icons">
                    <a class="btn btn-outline-light btn-primary me-2" href="https://www.facebook.com/smklenterabangsa/?_rdc=1&_rdr" target="_blank"><i class="fab fa-facebook-f"></i></a>
                    <a class="btn btn-outline-light btn-info me-2" href="https://www.instagram.com/lenterabangsa.id/" target="_blank"><i class="fab fa-instagram"></i></a>
                    <a class="btn btn-outline-light btn-danger me-2" href="https://www.youtube.com/watch?v=1b1NTGOx-lY#:~:text=Direksi:%20Ahmad%20JaelaniTalent%20:Endang%20Lasmana,%20SEMuhamad" target="_blank"><i class="fab fa-youtube"></i></a>
                    <a class="btn btn-outline-light btn-primary me-2" href="#" target="_blank"><i class="fab fa-linkedin-in"></i></a>
                    <a class="btn btn-outline-light btn-success me-2" href="https://wa.me/6285711325040" target="_blank"><i class="fab fa-whatsapp"></i></a>
                </div>
            </div>
