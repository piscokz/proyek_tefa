...
<head>
    ...
    <link href="{{ asset('guest/css/kontak.css') }}" rel="stylesheet">
    <link href="{{ asset('guest/css/styling.css') }}" rel="stylesheet">

    <!-- JavaScript to change navbar color on scroll -->
    <script src="{{ asset('guest/asset/js/navbar.js') }}"></script>
    <script src="{{  asset('guest/asset/js/type.js')}}"></script>
